...
#define EXTRUDE_MAXLENGTH 700  //VBNMODE medir e ajustar....
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 48  //VBNMODE X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -2   //VBNMODE Y offset: -front +behind [the nozzle]
...
#define XY_PROBE_SPEED 5700  //VBNMODE
...
#define X_BED_SIZE 235  //VBNMODE
#define Y_BED_SIZE 235  //VBNMODE
...
//#define MIN_SOFTWARE_ENDSTOPS  //VBNMODE
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //PIN 28 https://www.youtube.com/watch?v=GNGN2iSQ5j4
...
#define LEVEL_BED_CORNERS  //VBNMODE

#if ENABLED(LEVEL_BED_CORNERS)
  #define LEVEL_CORNERS_INSET 40    // (mm) An inset for corner leveling
  #define LEVEL_CORNERS_Z_HOP  18.0  // VBNMODE (mm) Move nozzle up before moving between corners
  #define LEVEL_CORNERS_HEIGHT 8.0  // VBNMODE (mm) Z height of nozzle at leveling points
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (30*60) //VBNMODE may be seated (20*60)
...
//
//#define ENCODER_PULSES_PER_STEP 4 //VBNMODE may be seated
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //VBNMODE
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 0 //VBNMODE
#define LCD_FEEDBACK_FREQUENCY_HZ 0 //VBNMODE
...
//
#define CR10_STOCKDISPLAY //VBNMODE
 ...
 */
#define NUM_SERVOS 1 //VBNMODE Servo index starts with 0 for M280 command
